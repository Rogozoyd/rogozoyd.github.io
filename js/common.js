...
(function() {
    ...
    var width, height, largeHeader, wallp, bubble, canvas, ctx, circles, target, animateHeader = true;
    ...
    function initHeader() {
        ...
        largeHeader = document.getElementById('wallp');
        largeHeader.style.height = height+'px';

        canvas = document.getElementById('bubble-demo');
        canvas.width = width;
    ...
    function Circle() {
        ...
        this.draw = function() {
            ...
            ctx.fillStyle = 'rgba(255,241,148,'+ _this.alpha+')';
            ctx.fill();
        };
    }
